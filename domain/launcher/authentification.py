...
class Authentification:
    ...
    def authentification(self) -> None:
        ...
        self.login_button.place(relx=0.26, rely=0.45, anchor=CENTER)
        ...
        self.register_button.place(relx=0.37, rely=0.45, anchor=CENTER)
    ...
    def addLogin(self):
        ...
        username.place(relx=0.205, rely=0.55, anchor=NW)
        ...
        self.loginUsername.place(relx=0.205, rely=0.58, anchor=NW)

        password = Label(self.window, text="Mot de passe :", font=("Arial", 16), bg="#0F2234", fg="#E3F8FF")
        password.place(relx=0.205, rely=0.65, anchor=NW)
    ...
    def addRegister(self):
        ...
        username = Label(self.window, text="Pseudo :", font=("Arial", 16), bg="#0F2234", fg="#E3F8FF")
        username.place(relx=0.205, rely=0.5, anchor=NW)
        ...
        self.registerUsername.place(relx=0.205, rely=0.53, anchor=NW)

        password = Label(self.window, text="Mot de passe :", font=("Arial", 16), bg="#0F2234", fg="#E3F8FF")
        password.place(relx=0.205, rely=0.58, anchor=NW)
        ...
        self.registerPassword.place(relx=0.205, rely=0.61, anchor=NW)

        passwordConfirm = Label(self.window, text="Confirmer le mot de passe :", font=("Arial", 16), bg="#0F2234", fg="#E3F8FF")
        passwordConfirm.place(relx=0.205, rely=0.66, anchor=NW)
        ...
        self.registerPasswordConfirm.place(relx=0.205, rely=0.69, anchor=NW)
            
        self.registerButton = Label(self.window, image=self.launcher.register_button, cursor="hand2", bd=0, highlightthickness=0)
        self.registerButton.place(relx=0.318, rely=0.8, anchor=CENTER)
